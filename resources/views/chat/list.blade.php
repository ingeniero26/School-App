...
<link rel="stylesheet" href="{{url('public/emojionearea/emojionearea.min.css')}}" rel="stylesheet">
<style type="text/css">
            ...
            <div class="card chat-app">
                <div id="plist" class="people-list">
                    <div class="input-group">
                        ...
                        <input type="text" hidden id="getReceiverIDDinamic" value="{{$receiver_id}}">
                    </div>
                    <ul class="list-unstyled chat-list mt-2 mb-0" id="getSearchUserDinamic">
                     @include('chat._user')
                    </ul>
                </div>
  ...
  <script type="text/javascript">
     $(".emojionearea").emojioneArea();
        ...
        $('body').delegate('.getChatWindows','click', function (e) {
            ...
            $('#getReceiverIDDinamic').val(receiver_id);
        ...
        $('body').delegate('#getSearchUser','click', function (e) {
            ...
            var receiver_id =$('#getReceiverIDDinamic').val();
            ...
            $.ajax({
                ...
                dataType: 'json',
                success: function(data){
                    $('#getSearchUserDinamic').html(data.success);
                },
                error: function(data){
