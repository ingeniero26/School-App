  ...
  <div class="col-md pt-5">
      <div class="ftco-footer-widget pt-md-5 mb-4">
         ...
         <div class="block-23 mb-3">
           <ul>
             <li><span class="icon fa fa-map-marker"></span><span class="text">Sede Principal: EL CARMEN DE BOLIVAR</span></li>
             <li><a href="#"><span class="icon fa fa-phone"></span><span class="text">3042567741</span></a></li>
  ...
  <div class="row">
    <div class="col-md-12 text-center">
      ...
      <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
        Copyright &copy;<script>document.write(new Date().getFullYear());</script> Derechos reservados <i class="fa fa-heart" aria-hidden="true"></i> by <a href="" target="_blank">UNITEC</a>
