                            ...
                            @foreach($getRecord as $value)
                               <tr>
                                ...
                                <td style="min-width: 470px">
                                    ...
                                    <a href="{{ url('parent/my_student/homework/'.$value->id) }}" class="btn btn-dark btn-sm">Tareas </a>
                                    <a href="{{ url('parent/my_student/submitted_homework/'.$value->id) }}" class="btn btn-success btn-sm">Tareas Enviadas</a>
                                </td>
                               </tr>
                            @endforeach
                       </tbody>
