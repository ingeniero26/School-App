                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Información de la Medida</h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <strong>Abreviatura:</strong> {{ $getRecord->abbreviation }}
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-6">
                    ...
                    <a href="{{ url('admin/measures/list')}}" class="btn btn-success">Atrás</a>
                </div>
            </div>
        </div>
    </section>
