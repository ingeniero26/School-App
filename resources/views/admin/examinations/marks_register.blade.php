                                                                    ...
                                                                    @if (!empty($getMark))
                                                                        <div style="margin-bottom:10px">
                                                                            ...
                                                                            @if ($totalMark >= $subject->passing_mark)
                                                                                Estado:<span
                                                                                    style="color: blue">Aprobado</span>
                                                                            @else
                                                            ...
                                                            <td style="min-width: 200px;">
                                                                <button type="submit" class="btn btn-success">
                                                                    ...
                                                                    <a class="btn btn-info"
                                                                        target="_blank"
                                                                        href="{{url('admin/my_exam_result/print?exam_id='. Request::get('exam_id').'&student_id='.$student->id)}}">Imprimir</a>
