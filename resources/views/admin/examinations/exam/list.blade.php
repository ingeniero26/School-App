                ...
                <tbody>
                    @foreach($getRecord as $value)
                       <tr>
                           ...
                           <td>
                               <a href="{{ url('admin/examinations/exam/edit/'.$value->id) }}" class="btn btn-warning">Editar</a>
                               <a href="{{ url('admin/examinations/exam/delete/'.$value->id) }}" class="btn btn-danger">Eliminar</a>
                           </td>
