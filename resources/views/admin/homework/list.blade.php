                ...
                <table id="example1" class="table  table-bordered table-striped">
                    ...
                    @forelse($getRecord as $value)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/homework/homework/edit/'.$value->id) }}" class="btn btn-warning">Editar</a>
                                    <a href="{{ url('admin/homework/homework/delete/'.$value->id) }}" class="btn btn-danger">Eliminar</a>
                                    <a href="{{ url('admin/homework/homework/submitted/'.$value->id) }}" class="btn btn-success">Tareas Enviadas</a>
                                </td>
