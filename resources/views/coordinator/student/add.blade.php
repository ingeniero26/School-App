                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" required class="form-control"
                                                value="{{ old('last_name') }}" placeholder="Apellido" name="last_name">
                                            <div style="color:red;">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="document_type" id="" required class="form-control">
                                                ...
                                                <option {{ old('document_type') == 'TI' ? 'selected' : '' }} value="TI">TI
                                                </option>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" required class="form-control"
                                                value="{{ old('admission_number') }}" placeholder="Matricula No"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="headquarter_id" id="" class="form-control" required>
                                                ...
                                                @foreach ($getHeadquater as $headquarter)
                                                    <option value="{{ $headquarter->id }}">{{ $headquarter->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="journey_id" id="" class="form-control" required>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="gender" id="" required class="form-control">
                                                ...
                                                <option {{ old('gender') == 'Female' ? 'selected' : '' }} value="Female">
                                                    Femenino</option>
                                                <option {{ old('gender') == 'Other' ? 'selected' : '' }} value="Other">Otro
                                                </option>
                                            </select>
                                            <div style="color:red;">
                                                {{ $errors->first('gender') }}
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date" required class="form-control"
                                                value="{{ old('date_of_birth') }}" placeholder="Fecha Matricula"
                                                name="date_of_birth">
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ old('mobile_number') }}" placeholder="" name="mobile_number">
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label> Fecha Admision<span style="color: red">*</span> </label>
                                            <input type="date" required class="form-control"
                                                value="{{ old('admission_date') }}" placeholder="Fecha Admision"
                                                name="admission_date">
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" value="{{ old('eps') }}"
