...
// listado de asignaturas del estudiante
    public static function MySubject($class_id)
    {
        return self::select('class_subject.*',
            'subject.name as subject_name',
            'subject.type as type ', 'exam.name as exam_name')
            ->join('subject', 'subject.id', '=', 'class_subject.subject_id')
            ->join('class', 'class.id', '=', 'class_subject.class_id')
            ->join('exam', 'exam.id', '=', 'class_subject.exam_id')
            ->join('users', 'users.id', 'class_subject.created_by')
     ...
     public static function MySubjectTotal($class_id)
    {
